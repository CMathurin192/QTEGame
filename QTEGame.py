"""Written by Caleb Mathurin
   ...
   Final Dev Notes: This was originally meant to be a much bigger project, but I decided to cut it short due to
   its effect on my mental and physical health. It is now a small demo showcasing game development in Pygame,
   menu design, socket programming, art design, etc."""
